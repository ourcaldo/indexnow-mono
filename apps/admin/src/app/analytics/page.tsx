...
import { Card, CardContent, CardHeader, CardTitle, CardDescription, Button, Badge, Select, SelectContent, SelectItem, SelectTrigger, SelectValue, Input, AdminPageSkeleton } from '@indexnow/ui'
import { 
  BarChart3, 
  TrendingUp,
  TrendingDown,
