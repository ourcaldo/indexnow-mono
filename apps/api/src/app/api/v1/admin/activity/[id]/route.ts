...
export const GET = adminApiWrapper(async (
  ...
  const mapLog = (l: Record<string, unknown>) => {
    ...
    return {
      ...
      target_type: (l.target_type as string) || (details.targetType as string) || (details.target_type as string) || null,
      target_id: (l.target_id as string) || (details.targetId as string) || (details.target_id as string) || null,
