...
export class FileValidator {
  ...
  async validateFiles(
    ...
    validFiles: Array<{ buffer: Buffer; name: string; metadata: FileValidationResult['metadata'] }>;
    invalidFiles: Array<{ name: string; errors: string[]; warnings: string[] }>;
  }> {
    const validFiles: Array<{ buffer: Buffer; name: string; metadata: FileValidationResult['metadata'] }> = [];
