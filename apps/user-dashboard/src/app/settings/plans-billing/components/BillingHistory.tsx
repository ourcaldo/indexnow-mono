...
import { Input, Select, Button, DataTable, StatusBadge } from '@indexnow/ui'
                  ...
                  {historyData.transactions.map((transaction) => (
                    ...
                    >
                      {columns.map((column) => (
                        ...
                        >
                          {column.render ? column.render(transaction[column.key as keyof Transaction], transaction) : (transaction as Record<string, unknown>)[column.key] as React.ReactNode}
                        </td>
                      ))}
                    </tr>
                  ))}
