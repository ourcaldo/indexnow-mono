  ...
  return (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Select the perfect plan for your rank tracking needs</p>
                    ...
                    {pkg.quota_limits?.rank_tracking_limit && (
                      <div className="flex justify-between text-sm">
                        ...
                        <span className="text-foreground font-medium">
                          {pkg.quota_limits.rank_tracking_limit === -1 ? 'Unlimited' : pkg.quota_limits.rank_tracking_limit.toLocaleString()}
                        </span>
                      </div>
                    )}
