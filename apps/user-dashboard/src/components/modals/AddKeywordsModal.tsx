    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center">
      ...
      <div className="relative w-full max-w-2xl mx-4 bg-white rounded-2xl shadow-2xl border border-gray-200 overflow-hidden animate-in fade-in zoom-in-95 duration-200 max-h-[90vh] flex flex-col">
        ...
        <div className="flex items-center justify-center gap-3 px-6 py-3 bg-gray-50/80 border-b border-gray-100 shrink-0">
          ...
          <div className={`h-px w-8 ${step >= 2 ? 'bg-blue-500' : 'bg-gray-300'}`} />
        ...
        <div className="flex-1 overflow-y-auto px-6 py-5">
          {isLoading ? (
            ...
            <div className="space-y-4">
                    ...
                    <div className="absolute top-full left-0 right-0 mt-1 bg-white border border-gray-200 rounded-xl shadow-xl z-20 max-h-60 overflow-hidden">
                      <div className="p-2 border-b border-gray-100">
                        <input
                          ...
                          className="w-full px-3 py-1.5 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 text-gray-900 placeholder:text-gray-400"
                        />
                      </div>
              ...
              {!showAddDomain ? (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-gray-600 border border-dashed border-gray-300 rounded-xl hover:border-blue-500 hover:text-blue-600 transition-colors"
                >
                ...
                <div className="p-4 border border-gray-200 rounded-xl bg-gray-50/50 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <input
                      ...
                      className="flex-1 px-3 py-2 text-sm bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 text-gray-900 placeholder:text-gray-400"
                    />
                    <button
            ...
            <div className="space-y-5">
              ...
              {selectedDomain && (
                <div className="flex items-center justify-between px-3 py-2.5 bg-blue-50 border border-blue-100 rounded-xl">
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 text-sm bg-gray-50 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-blue-500/40 focus:border-blue-500 text-gray-900 placeholder:text-gray-400 resize-none font-mono leading-relaxed transition-all"
                />
              ...
              <div>
                ...
                <div className="flex gap-2">
                  <input
                    ...
                    className="flex-1 px-3 py-2 text-sm bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-blue-500 text-gray-900 placeholder:text-gray-400"
                  />
                  <button
                ...
                {tags.length > 0 && (
                  <div className="flex flex-wrap gap-1.5 mt-2">
                    {tags.map(tag => (
                      <span
                        key={tag}
                        className="inline-flex items-center gap-1 px-2.5 py-1 text-xs font-medium bg-blue-50 text-blue-700 border border-blue-100 rounded-lg"
                      >
