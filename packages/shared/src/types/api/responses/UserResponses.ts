...
import type { 
  AppUserProfile, AppUserSettings, UserQuotaUsage, UserQuotaLimits, 
...
export interface GetUserProfileResponse extends ApiResponse<AppUserProfile> {}

export interface UpdateUserProfileResponse extends ApiResponse<AppUserProfile> {}

export interface GetUserSettingsResponse extends ApiResponse<AppUserSettings> {}

export interface UpdateUserSettingsResponse extends ApiResponse<AppUserSettings> {}
...
export interface GetUsersResponse extends PaginatedResponse<AppUserProfile> {}
