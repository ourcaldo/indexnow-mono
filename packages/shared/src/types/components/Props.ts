...
export interface TableProps<T = Record<string, Json>> extends BaseComponentProps {
  data: T[];
...
export interface TableColumn<T = Record<string, Json>> {
  key: keyof T;
  title: string;
  width?: string;
  sortable?: boolean;
  render?: (value: Json, row: T, index: number) => React.ReactNode;
  className?: string;
}
...
export interface FormProps extends BaseComponentProps {
  onSubmit: (data: Record<string, Json>) => void | Promise<void>;
  isLoading?: boolean;
  disabled?: boolean;
...
export interface NavItem extends ComponentNavigationItem {}
export interface SidebarItem extends ComponentNavigationItem {}
...
export interface FormField extends BaseComponentProps {
  name: string;
  label: string;
  type?: string;
  placeholder?: string;
