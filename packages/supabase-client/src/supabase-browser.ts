 ...
 *
 * (#V7 M-08) WARNING: Each call registers a new onAuthStateChange listener.
 * Always use getBrowserClient() / supabaseBrowser singleton to avoid duplicate listeners.
 *
